        ...
        <form style={{ padding: '24px 24px 0 24px' }}>
          <div style={{display:'flex',gap:32,alignItems:'flex-start',flexWrap:'wrap'}}>
            ...
            <div style={{minWidth:220,maxWidth:260,flex:'0 0 220px',display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'flex-start'}}>
              ...
              >
                {logoPreview ? (
                  <img src={logoPreview} alt="Logo" style={{maxWidth: '90%', maxHeight: '90%', borderRadius: 8, objectFit: 'contain'}} />
                ) : (
                  <>
          ...
          <div style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '28px' }}>
            <button type="button" className="empresa-btn-guardar" style={{background:'linear-gradient(90deg,#2563eb 0%,#2563eb 100%)',color:'#fff',fontWeight:700,padding:'12px 32px',fontSize:15,borderRadius:10,boxShadow:'0 2px 8px rgba(37,99,235,0.10)',display:'flex',alignItems:'center',gap:10,border:'none',cursor:'pointer'}}>
