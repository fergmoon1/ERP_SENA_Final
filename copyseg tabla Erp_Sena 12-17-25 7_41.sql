...
INSERT INTO `cliente` VALUES (1,'ventas@distribuidoraxyz.com','Calle 80 #12-34, Barranquilla','Distribuidora XYZ Ltda','6012345678','Empresa','2024-06-01'),(2,'stock_client@gmail.com','Calle 20 #13-45, Medellin','Cliente Stock-Test','6644578','Individual','2024-06-01'),(3,'cliente1@correo.com','Calle 50 #10-20, Bogotá','Cliente Ejemplo 1','3001112233','Individual','2024-06-01'),(4,'empresa2@correo.com','Carrera 7 #45-67, Cali','Empresa Ejemplo 2','3202223344','Empresa','2024-06-01'),(5,'clienteadmin@erp.com',NULL,'Cliente Admin','123456789',NULL,'2024-06-01'),(6,'clientesupervisor@erp.com',NULL,'Cliente Supervisor','987654321',NULL,'2024-06-01'),(7,'clienteadmin@erp.com',NULL,'Cliente Admin','123456789',NULL,'2024-06-01'),(8,'clientesupervisor@erp.com',NULL,'Cliente Supervisor','987654321',NULL,'2024-06-01'),(9,'clienteadmin@erp.com',NULL,'Cliente Admin','123456789',NULL,'2024-06-01'),(10,'clientesupervisor@erp.com',NULL,'Cliente Supervisor','987654321',NULL,'2024-06-01'),(11,'clienteadmin@erp.com',NULL,'Cliente Admin','123456789',NULL,'2024-06-01'),(12,'clientesupervisor@erp.com',NULL,'Cliente Supervisor','987654321',NULL,'2024-06-01'),(13,'clienteadmin@erp.com',NULL,'Cliente Admin','123456789',NULL,'2024-06-01'),(14,'clientesupervisor@erp.com',NULL,'Cliente Supervisor','987654321',NULL,'2024-06-01'),(15,'clienteadmin@erp.com',NULL,'Cliente Admin','123456789',NULL,'2024-06-01'),(16,'clientesupervisor@erp.com',NULL,'Cliente Supervisor','987654321',NULL,'2024-06-01'),(17,'cliente@test.com','Calle Test 123','Cliente Test','3001234567','Individual','2025-07-07'),(19,'cliente@test.com','Calle Test 123','Cliente Test','3001234567','Individual','2025-07-08'),(20,'cliente@test.com','Calle Test 123','Cliente Test','3001234567','Individual','2025-07-08'),(22,'cliente@test.com','Calle Test 123','Cliente Test','3001234567','Individual','2025-07-08'),(24,'cliente@test.com','Calle Test 123','Cliente Test','3001234567','Individual','2025-07-08');
...
INSERT INTO `detalle_pedido` VALUES (3,2,3,4,NULL),(4,2,4,1,NULL),(5,3,5,2,NULL),(34,37,5,1,600),(35,38,3,1,50),(36,39,3,1,50),(61,46,1,2,10000),(62,46,2,1,5000);
...
INSERT INTO `producto` VALUES (1,'Producto Actualizado','Actualización automatizada',150,50),(2,'Producto de prueba 2','Descripción de prueba 2',110,56),(3,'Producto para Prueba-1','Producto para probar la gestión de stock- Agregar producto- modulo Productos',50,1),(4,'Teclado USB','Teclado estándar para PC',40,15),(5,'Impresora HP','Impresora multifuncional',600,3),(6,'Producto Temporal','Para pruebas DELETE',1,1);
...
INSERT INTO `refresh_token` VALUES (115,'d1b297bf-f9b0-4908-9149-d6ed81539769',10,'2025-07-14 10:51:01'),(183,'d0fc3b9c-a9a3-47e1-8d60-f8ae43393fdb',1,'2025-07-19 18:36:06');
...
INSERT INTO `usuario` VALUES (1,'admin@erp.com','Administrador','$2a$12$UOUtsiSzhqfoawIkAgEVnO/19JcxLwiBgcso4hsfKjyz/vUjp0y8O','ADMIN',1,NULL),(2,'supervisor@erp.com','Supervisor','$$2a$12$acw1pyH7wtSI6zWI1BueSe1Yecr7nDmWxzPnLvrI4GHAqDlhmqIxW','SUPERVISOR',1,NULL),(3,'user@erp.com','Usuario','$$2a$12$KtyGf1oIe.PZLzkbpURc3ebkU.Aj4ja6qldl3lNLoZF8QQDXcEsnW','USER',1,NULL),(4,'ventas@erp.com','Vendedor','$2a$10$HzUnILP.0ib3.rszmAnhWeKUhPt35HB0.0Z65ouFLcFirtwKFLAOq','VENDEDOR',1,NULL),(5,'inventario@erp.com','Inventario','$2a$10$HzUnILP.0ib3.rszmAnhWeKUhPt35HB0.0Z65ouFLcFirtwKFLAOq','INVENTARIO',1,NULL),(6,'nuevo1751309011@erp.com','Nuevo Usuario','nuevo123','USER',1,NULL),(7,'nuevo1751309084@erp.com','Nuevo Usuario','$2a$10$8XOAgVuh2130J0xpS1d0RumZB2GMqg5RkB31AAZEPcJt8.Dse1FnS','USER',1,NULL),(10,'dim.dei@gmail.com','FERNANDO GOMEZ','$2a$10$3oafoYXivuioHSDFGzHlRuMlzuSJDFW0M1rTyf040x8W2bInyAChq','ADMIN',1,''),(27,'juana.perez@erp.com','Juana Pérez','$2a$10$jYn/6WIOP9PMDNdRX/UrOuwZbEpOG13bencVId0jcYoT1LbZsT9jG','ADMIN',1,'/uploads/avatar_27_1752363512183_foto01_mujer.png');
...
-- Dump completed on 2025-07-12 19:42:45
